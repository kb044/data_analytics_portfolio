...
#load data @st.cache_data only updates the data when there are updates
...
#sidebar showing random tweet by sentiment -- one tweet per click
st.sidebar.subheader("Show random tweet")
random_tweet = st.sidebar.radio('Sentiment', ('positive', 'neutral', 'negative'))
st.sidebar.markdown(data.query("airline_sentiment == @random_tweet")[["text"]].sample(n=1).iat[0, 0])

#show chart with total number of tweets by sentiment
...
#set up map to show where tweets are coming from
